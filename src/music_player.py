...
class MusicPlayer(tk.Frame):
    def __init__(self, container):
        ...
        self.play_button.configure(highlightthickness = 0, activebackground = color_btn, activeforeground = color_text)
        ...
        self.pause_button.configure(highlightthickness = 0, activebackground = color_btn, activeforeground = color_text)
        ...
        self.stop_button.configure(highlightthickness = 0, activebackground = color_btn, activeforeground = color_text)
        self.stop_button.place(relheight = 0.05, relwidth = 0.08, relx = 0.35, rely = 0.15, anchor = "center")
        
        self.playing_state = False
        

    # fetch the song and create the mp3 file with the song in the directory
    def load(self, year, song_index):
